...
if __name__ == "__main__":
    ...
    g.hlines(
        y=[
            df_base_grp.loc[
                df_base_grp.index == "Ember-PN-Baseline-model-0.00", "roc_auc_lo"
            ],
            df_base_grp.loc[
                df_base_grp.index == "Ember-PN-Baseline-model-0.00", "roc_auc_hi"
            ],
        ],
    ...
    g.set_title("Ember dataset - ROC AUC")
    plt.show()
    ...
    print(
        ...
        df_base_grp.loc[
            df_base_grp.index == "Ember-PN-Baseline-model-0.00", "roc_auc_mean"
        ],
        df_base_grp.loc[
            df_base_grp.index == "Ember-PN-Baseline-model-0.00", "roc_auc_hi"
        ],
