...
if __name__ == "__main__":
    ...
    g.hlines(
        y=[
            df_base_grp.loc[
                df_base_grp.index == "DGA-Baseline-PN-model-0.00", "brier_score_lo"
            ],
            df_base_grp.loc[
                df_base_grp.index == "DGA-Baseline-PN-model-0.00", "brier_score_hi"
            ],
        ],
    ...
    g.hlines(
        y=[
            df_base_grp.loc[
                df_base_grp.index == "DGA-Baseline-PN-model-0.00", "error_rate_lo"
            ],
            df_base_grp.loc[
                df_base_grp.index == "DGA-Baseline-PN-model-0.00", "error_rate_hi"
            ],
        ],
        xmin=df_xpmt["Positives among Unlabeled (%)"].min(),
        xmax=df_xpmt["Positives among Unlabeled (%)"].max(),
    ...
    g.hlines(
        y=[
            df_base_grp.loc[
                df_base_grp.index == "DGA-Baseline-PN-model-0.00", "cross_entropy_lo"
            ],
            df_base_grp.loc[
                df_base_grp.index == "DGA-Baseline-PN-model-0.00", "cross_entropy_hi"
            ],
        ],
        xmin=df_xpmt["Positives among Unlabeled (%)"].min(),
        xmax=df_xpmt["Positives among Unlabeled (%)"].max(),
    ...
    fig.suptitle("Experiment 1 (DGA)", fontsize=16)
    plt.show()
